...
- Analytics upload
    - Note that the patches do not by themselves eliminate all analytics upload; only optional Affinity's own opt-in ones are denied.
    - If you would like to eliminate analytics generated by [Snowplow](https://github.com/Still34/AffinityPatcher/issues/11) that gets fired regularly, install the patches under `no_sp_analytics.zip` included in each release.
